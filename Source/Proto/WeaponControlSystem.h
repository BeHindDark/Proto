...
public:
	UFUNCTION(BlueprintCallable, Category = Category = "Custom|WeaponControlSystem")
	bool SetActiveWeaponGroup(int WeaponGroupIndex);
	...
	*/
	bool SyncNewWeapon(class ABaseWeapon* NewWeapon, int WeaponIndex, int WeaponGroupIndex);
	...
	*/
	bool SetWeaponSocket(class UArrowComponent* NewSocketArrow, int WeaponIndex);
